    ...
    <div className="relative flex items-center justify-center min-h-screen" >
      ...
      <div className="max-w-3xl w-full p-10 rounded-md">
        ...
        <div className="container grid grid-cols-2 mx-auto p-2">
          ...
          <p className=" col-span-2 border-b border-[#D9D6E1] pb-1">{ficha.objectives}</p>
          ...
          <p className='col-span-2 mb-3 className="col-span-2 border-t border-[#D9D6E1] pb-1"'><strong>Material de Respaldo:</strong></p>
          <ul>

  ...
  return (
    <div className="w-full min-h-screen bg-white font-sans">
      ...
      <div className="relative w-full">
        ...
        <div className="absolute object-cover sm:bottom-1 md:bottom-3 left-1/2 transform -translate-x-1/2  text-white  items-center justify-between">
          <span className=" object-cover text-white text-2xl sm:text-3xl md:text-4xl"> 
          {language === "es"

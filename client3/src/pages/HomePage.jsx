  ...
  return (
    <div className="w-full min-h-screen bg-white font-sans">
      ...
      <div className="relative w-full">
        ...
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-top w-16 h-16 md:w-24 md:h-24 text-white flex items-center justify-center z-20">
          <img src="/fecha.svg" className="w-full h-auto" />
        </div>
      </div>

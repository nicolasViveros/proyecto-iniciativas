  ...
  return (
    <div className="w-full min-h-screen bg-white font-sans">
      ...
      <div className="relative w-full">
        ...
        <div className="absolute top-1/11 left-1/2 transform -translate-x-1/2 w-16 h-16 md:w-34 md:h-34 text-white  items-center justify-centers z-20 hidden sm:flex">
          <img src="/fecha.svg" className="w-full h-auto" />
        </div>
      </div>

  ...
  return (
    <div className="w-full min-h-screen bg-white font-sans">
      ...
      <div className="relative w-full">
        ...
        <div className="absolute botton-0 left-1/2 transform -translate-x-1/2 w-16 h-16 md:w-24 md:h-24 text-white  items-center justify-center z-20 hidden sm:flex">
          <span className="w-full h-auto text-white text-5xl"> ¡Participa! 15/07 al 15/08</span>
        </div>
      </div>

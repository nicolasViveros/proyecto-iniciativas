...
function HomePage() {
  ...
  const secciones = [
    ...
    },
    {
      ...
      contenido: `El propósito del concurso es: Reconocer, visibilizar y promover iniciativas innovadoras en favor de la equidad e inclusión de género en la movilidad urbana, en América Latina y El Caribe. Se evaluarán mejor aquellas iniciativas con mayor impacto sobre la equidad e inclusión y potencial de replicabilidad y sostenibilidad en el tiempo.
      Este concurso está dirigido a instituciones públicas, empresas privadas, organizaciones de la sociedad civil y entidades académicas que lideren este tipo de iniciativas`,
    },
    {
  ...
  return (
    <div className="w-full min-h-screen bg-white font-sans">
      ...
      <div className="relative w-full">
        ...
        />
        <div className="absolute inset-0 flex flex-col items-start p-4 z-10 space-y-2">

    ...
    <div className="w-full min-h-screen bg-white font-sans">
      ...
      <div className="relative w-full">
        ...
        <div className="absolute sm:top-1/8 sm:left-2/12 transform -traslate-x-3/12 top-14 left-2">
          ...
          <p className="text-xs md:text-lg sm:text-xl text-[#5A478D] leading-tight w-60 sm:w-90">
            Reconociendo iniciativas innovadoras en favor de la
            equidad de género en movilidad urbana
          </p>
        </div>
       
        <div className="absolute top-4 left-1/2 transform -translate-x-1/2 w-16 h-16 md:w-34 md:h-34 text-white  items-center justify-center z-20 hidden sm:flex">
          <img src="/fecha.svg" className="w-full h-auto" />
        </div>
      </div>

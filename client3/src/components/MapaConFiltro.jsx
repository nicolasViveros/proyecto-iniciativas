  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between bg-white p-8 rounded-xl shadow-md mx-auto">
      <div className="relative w-full h-150">
        ...
        {mostrarFiltro && (
          <div className="absolute top-0 right-0 h-130 bg-white shadow-lg w-104 overflow-hidden z-10">
        ...
        {(paisSeleccionado || ciudadSeleccionado) && (
          <div className="absolute top-0 right-0 h-130 bg-white shadow-lg w-104 z-20 overflow-y-auto">
